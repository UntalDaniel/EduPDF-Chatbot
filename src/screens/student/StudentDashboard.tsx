        ...
        <div className="min-h-screen bg-slate-900 text-white">
            <nav className="bg-slate-800 p-4">
                <div className="container mx-auto flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-sky-400">EduPDF - Panel de Estudiante</h1>
                    <button
                    ...
                    {pdfs.map((pdf) => (
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <button
                                    onClick={() => navigate(`/student/view-activity?pdfId=${pdf.id}`)}
                                ...
                                <button
                                    onClick={() => navigate(`/student/view-exam?pdfId=${pdf.id}`)}
                ...
                {pdfs.length === 0 && !loading && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-slate-500">
                            No hay PDFs disponibles para ver en este momento.
                        </p>
                    </div>
                )}
            </main>
